...
export function CreateRequestModal({ onClose, onSubmit, isSaving }: { onClose: () => void; onSubmit: (input: NewRequestInput) => void; isSaving: boolean }) {
  ...
  const dialogRef = useDialog<HTMLDivElement>(onClose, { locked: isSaving });
